...
class Venda {
    ...
    public Venda(int id, int idProduto, int quantidade, double valorTotal, String data) {
        this.id = id;
        this.idProduto = idProduto;
        this.quantidade = quantidade;
        this.valorTotal = valorTotal;
...
public class Main {
    public static void main(String[] args) {
        ...
        Venda venda = new Venda(25, 25, 1, 3.000, "20/11/2023");
        sistema.registrarVenda(venda);

        // Exemplo: Registrar uma compra
        Compra compra = new Compra(25, 25, 1, 3.000, "25/03/2023");
